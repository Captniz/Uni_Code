...
node *makeOperation(node *&a, node *&b);
...
/*
NOTE ( Mi sta venendo un aneurisma dio ***** ) :
 - Nodi tipi : Decisionali ( a,b,c,d ) / Finali ( 0,1 )
 - Variabile booleana: Lo stracazzo di nodo decisionale
 - Sinistra false e destra true
 - Albero ORDINATO non so cosa straminchia voglia dire
*/
